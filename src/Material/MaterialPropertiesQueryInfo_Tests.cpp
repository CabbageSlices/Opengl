...
// TEST_F(MaterialPropertiesQueryInfoTests, setAndGetAttributeValues) {
...
// TEST_F(MaterialPropertiesQueryInfoTests, materialActivatesCorrectShaderProgram) {
...
// TEST_F(MaterialPropertiesQueryInfoTests, materialIsBoundToUniformBlocksBindingIndex) {
//     GLint currentProgram;
...
// // the shader
// TEST_F(MaterialPropertiesQueryInfoTests, materialBufferHasCorrectMemoryLayout) {
//     glm::vec4 diffuse(1, 1, 0.5, 1);
//     float specularCoefficient = 256;
...
// TEST_F(MaterialPropertiesQueryInfoTests, canSetAndGetBoolAndGettingBoolAsIntFails) {
...
// TEST_F(MaterialPropertiesQueryInfoTests, settingBooleanWillSetCorrectSizeToMatchGLSL) {
//     bool diffuseTexture_Provided = true;
...
// TEST_F(MaterialPropertiesQueryInfoTests, whenTextureIsAddedMaterialBooleansAreCreatedAndSetToTrue) {
...
//     try {
//         bool textureFlagInMaterial = mat.getAttribute<bool>("diffuseTexture" +
//         Material::materialTextureProvidedFlagPrefix); EXPECT_EQ(textureFlagInMaterial, true);
//     } catch (...) {
...
// TEST_F(MaterialPropertiesQueryInfoTests,
...
// TEST_F(MaterialPropertiesQueryInfoTests, copyingExistingMaterialToNewMaterialWillCopyDataAndUseSameShadersAndTextures) {
//     glm::vec4 diffuse(1, 1, 0.5, 1);
//     float specularCoefficient = 256;
//     const ImageTextureResource::Channels desiredChannels = ImageTextureResource::Channels::AUTO;
//     GLuint textureUnit = 23;
...
// TEST_F(MaterialPropertiesQueryInfoTests,
// copyingExistingMaterialToExistingMaterialWillCopyDataAndUseSameShadersAndTextures) {
//     glm::vec4 diffuse(1, 1, 0.5, 1);
//     float specularCoefficient = 256;
//     const ImageTextureResource::Channels desiredChannels = ImageTextureResource::Channels::AUTO;
//     GLuint textureUnit = 23;
