 ...
 * MeshRenderer class to keep track of all opengl buffers for rendering. This class is in charge of sending position data and
 * other transformation matrices to the shader.
 */
