...
public:
     ...
     */
    void vertexAttributeShaderLocationToBufferIndex(GLuint shaderLocation, GLuint bufferBindingIndex, bool enableAttribute = true);


    //connect the given index buffer to the vertex aarray object, that way when this vertex array object is bound to the context
    //the attatched buffer is bound as well
     ...
     */
    void formatVertexAttributeData(GLuint shaderAttributeLocation, GLuint numElementsPerEntry, GLenum dataType, GLuint offset = 0, bool normalize = false);
